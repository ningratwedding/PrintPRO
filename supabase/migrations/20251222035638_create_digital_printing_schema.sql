...
CREATE TABLE IF NOT EXISTS product_templates (
  ...
  name text NOT NULL,
  code text NOT NULL,
  category text NOT NULL, -- banner, stiker, brosur, kemasan, kaos, merchandise
  description text,
...
CREATE TABLE IF NOT EXISTS materials (
  ...
  name text NOT NULL,
  code text NOT NULL,
  category text NOT NULL, -- substrate, ink, chemical, packaging, etc
  unit text NOT NULL,
...
CREATE TABLE IF NOT EXISTS inventory_movements (
  ...
  reference_type text, -- order, work_order, adjustment, transfer
  reference_id uuid,
  notes text,
...
CREATE TABLE IF NOT EXISTS inventory_reservations (
  ...
  reference_type text NOT NULL, -- order, work_order
...
CREATE TABLE IF NOT EXISTS machines (
  ...
  name text NOT NULL,
  code text NOT NULL,
  machine_type text NOT NULL, -- printer, laminator, cutter, etc
...
CREATE TABLE IF NOT EXISTS cost_centers (
  ...
  name text NOT NULL,
  code text NOT NULL,
  cost_type text NOT NULL, -- overhead, labor, etc
  allocation_basis text, -- per_hour, per_item, percentage
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  order_type text NOT NULL, -- quotation, sales_order
  status text DEFAULT 'draft', -- draft, confirmed, production, delivered, invoiced, paid, cancelled
...
CREATE TABLE IF NOT EXISTS order_items (
  ...
  product_specs jsonb DEFAULT '{}'::jsonb, -- dynamic attributes
  quantity decimal(15,4) NOT NULL,
  unit text NOT NULL,
...
CREATE TABLE IF NOT EXISTS deliveries (
  ...
  driver_name text,
  vehicle_number text,
  status text DEFAULT 'prepared', -- prepared, in_transit, delivered, returned
  notes text,
  user_id uuid REFERENCES auth.users(id),
  created_at timestamptz DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS invoices (
  ...
  due_date date,
  customer_id uuid REFERENCES customers(id) ON DELETE SET NULL,
  customer_snapshot jsonb, -- snapshot of customer data
...
CREATE TABLE IF NOT EXISTS payments (
  ...
  payment_method text NOT NULL, -- cash, transfer, card, qris
